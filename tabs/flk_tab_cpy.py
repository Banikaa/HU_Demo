...
class FlkTab(QLabel):
    ...
    def set_initial_state_labels(self):
        self.finger_1 = photo_descript_lbl.PhotoDescriptionLabel(
            'finger_1', 'Finger 1', 'red', True, stretch=True)
    ...
    # setting up the toolbar for the tab
    ...
    def reset_labels(self):
        # try:
        #     self.set_initial_state_labels()
        #     self.set_photo_labels(self.model_output, self.img_np_array)
        #     self.paint_buttons()
...
# ------------------------------------------------------------------------
    ...
    def change_label_dimension(self):
        ...
        for label in self.fingers:
            label.image_part.set_height(height)
            label.image_part.set_width(width)
            label.set_width(width)
            label.set_height(height)
        for label in self.knuckles_m:
            label.image_part.set_height(height)
    ...
    def tool_bar(self):
        ...
        self.togle_left_right = QAction("Left", self)
